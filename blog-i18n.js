...
(function () {
  ...
  var I18N = {
    tr: {
      ...
      "cm.title": "Yorumlar",
      "cm.empty": "Yorumlar yükleniyor…",
      "cm.form": "Yorum Yap",
      "cm.name": "Adınız *",
      "cm.email": "E-posta (isteğe bağlı)",
      "cm.content": "Yorumunuz… *",
      "cm.submit": "Gönder",
      share: "Paylaş",
      wa: "WhatsApp",
      copy: "Kopyala",
      ...
      reply: "↩ Yanıtla",
      like: "Beğen",
      "ft.tag": "Araştırma Blogu",
      "ft.copy": "© {0} Quantro ARGE · Kayseri, Türkiye",
    },
    en: {
      "nav.home": "← Home",
      ...
      "cm.title": "Comments",
      "cm.empty": "Loading comments…",
      "cm.form": "Leave a Comment",
      "cm.name": "Your name *",
      "cm.email": "Email (optional)",
      "cm.content": "Your comment… *",
      "cm.submit": "Submit",
      share: "Share",
      wa: "WhatsApp",
      copy: "Copy",
    ...
    fr: {
      ...
      "cm.title": "Commentaires",
      "cm.empty": "Chargement des commentaires…",
      "cm.form": "Commenter",
      "cm.name": "Votre nom *",
      "cm.email": "E-mail (facultatif)",
      "cm.content": "Votre commentaire… *",
      "cm.submit": "Envoyer",
      share: "Partager",
      wa: "WhatsApp",
      copy: "Copier",
    ...
    es: {
      ...
      "cm.title": "Comentarios",
      "cm.empty": "Cargando comentarios…",
      "cm.form": "Comentar",
      "cm.name": "Tu nombre *",
      "cm.email": "Correo (opcional)",
      "cm.content": "Tu comentario… *",
      "cm.submit": "Enviar",
      share: "Compartir",
      wa: "WhatsApp",
      copy: "Copiar",
      ...
      reply: "↩ Responder",
      like: "Me gusta",
      "ft.tag": "Blog de investigación",
      "ft.copy": "© {0} Quantro ARGE · Kayseri, Turquía",
    },
    it: {
      "nav.home": "← Home",
      ...
      "cm.title": "Commenti",
      "cm.empty": "Caricamento commenti…",
      "cm.form": "Commenta",
      "cm.name": "Il tuo nome *",
      "cm.email": "Email (facoltativa)",
      "cm.content": "Il tuo commento… *",
      "cm.submit": "Invia",
      share: "Condividi",
      wa: "WhatsApp",
      copy: "Copia",
      ...
      reply: "↩ Rispondi",
      like: "Mi piace",
      "ft.tag": "Blog di ricerca",
      "ft.copy": "© {0} Quantro ARGE · Kayseri, Turchia",
    },
    ru: {
      "nav.home": "← Главная",
      skip: "К содержанию",
      ...
      "cm.empty": "Загрузка комментариев…",
      "cm.form": "Оставить комментарий",
      "cm.name": "Ваше имя *",
      "cm.email": "Email (необязательно)",
      "cm.content": "Ваш комментарий… *",
      "cm.submit": "Отправить",
      share: "Поделиться",
      wa: "WhatsApp",
      copy: "Копировать",
      ...
      reply: "↩ Ответить",
      like: "Нравится",
      "ft.tag": "Исследовательский блог",
      "ft.copy": "© {0} Quantro ARGE · Кайсери, Турция",
    },
    ko: {
      "nav.home": "← 홈",
      skip: "콘텐츠로 건너뛰기",
      ...
      like: "좋아요",
      "ft.tag": "연구 블로그",
      "ft.copy": "© {0} Quantro ARGE · 카이세리, 튀르키예",
    },
    ar: {
      "nav.home": "← الرئيسية",
      ...
      "cm.title": "التعليقات",
      "cm.empty": "جارٍ تحميل التعليقات…",
      "cm.form": "أضف تعليقًا",
      "cm.name": "اسمك *",
      "cm.email": "البريد الإلكتروني (اختياري)",
      "cm.content": "تعليقك… *",
      "cm.submit": "إرسال",
      share: "مشاركة",
      wa: "WhatsApp",
      ...
      reply: "↩ رد",
      like: "إعجاب",
      "ft.tag": "مدونة الأبحاث",
      "ft.copy": "© {0} Quantro ARGE · قيصري، تركيا",
    },
  };
  ...
  var uq;
  try {
    uq = new URLSearchParams(location.search).get("lang");
  } catch (e) {
    uq = null;
  }
  ...
  function toggle() {
    ...
    apply();
    if (window.__blogOnLangSwitch) {
      try {
        window.__blogOnLangSwitch();
      } catch (e) {}
    }
  }
